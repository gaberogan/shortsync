export default function Privacy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to ShortSync.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to ShortSync, accessible from{' '}
            <a href="https://shortsync.app" rel="external nofollow noopener" target="_blank">
              https://shortsync.app
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>By email: admin@shortsync.app</li>
      </ul>
    </div>
  )
}
